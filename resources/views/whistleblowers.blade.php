                        ...
                        <div class="card card-primary">
                            <div class="row m-0">
                                <div class="col-12 col-md-12 col-lg-12 p-0">
                                    ...
                                    <div class="row m-0">
                                        <div class="card-body">
                                            <form method="POST" action="{{ route('post.send.whistle') }}">
                                                @csrf
                                                <div class="form-group floating-addon">
                                                    <textarea class="form-control" name="message" placeholder="Type your message" rows="20" cols="50"></textarea>
                                                </div>
                                                @error('message')
                                                    <div style="color: red;">
                                                        {{ $message }}
                                        ...
                                        <div class="col-12 col-md-12 col-lg-7 p-0">
                                            <iframe
                                                ...
                                                width="800" height="500" style="border:0; height: 400px"
