                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card-body">
                                            <form method="POST" action="{{ route('update.committe',$committe->id) }}" enctype="multipart/form-data">
                                                @csrf
                                                @method('PUT')
                                                <div class="form-group row mb-4">
                                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Name</label>
                                                    <div class="col-sm-12 col-md-7">
                                                        <input type="text" name="name" value="{{$committe->name}}" class="form-control">
                                                        @error('name')
                                                        <div style="color: red;">
                                                            {{ $message }}
                                                        </div>
                                                ...
                                                <div class="form-group row mb-4">
                                                    ...
                                                    <div class="col-sm-12 col-md-7">
                                                        <input type="text" name="position" value="{{$committe->position}}" class="form-control">
                                                        @error('position')
                                                        <div style="color: red;">
                                                            {{ $message }}
                                                        </div>
