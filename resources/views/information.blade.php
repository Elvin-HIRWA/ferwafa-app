          ...
          <div class="card card-primary">
            <div class="row m-0">
              <div class="col-12 col-md-12 col-lg-12 p-0">
                ...
                <div class="row m-0">
                  <div class="card-body">
                    <form method="POST" action="{{ route('post.send.info') }}">
                      @csrf
                      ...
                      <div class="form-group floating-addon">
                        <div class="input-group">
                          ...
                          <input id="email" type="text" class="form-control" name="subject" placeholder="Subject">
                        </div>
                        @error('subject')
                        <div style="color: red;">
                          {{ $message }}
                      ...
                      <div class="form-group floating-addon">
                        <textarea class="form-control" placeholder="Type your message" rows="6" name="content" cols="50"></textarea>
                      </div>
                      @error('content')
                      <div style="color: red;">
                        {{ $message }}
