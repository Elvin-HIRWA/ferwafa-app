                      ...
                      <form method="POST">
                        ...
                        <div class="form-group floating-addon">
                          <div class="input-group">
                            ...
                            <input id="email" type="email" class="form-control" name="email" placeholder="Subject">
                          </div>
                        </div>
                        <div class="form-group floating-addon">
                          <textarea class="form-control" placeholder="Type your message" rows="6" cols="50"></textarea>
                        </div>
