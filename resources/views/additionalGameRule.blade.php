    ...
    <div id="layout">
        ...
        <div class="section-title" style="background: url(../static/img/background/footballnew.jpg)">
            <div class="container">
                <div class="row">
                    <div class="col-md-8">
                        <h1 class="banner-title-main">Additional Game Rules</h1>
                    </div>
                    <div class="col-md-4">
                        <div class="breadcrumbs">
                            <ul>
                                <li><a href="/">Home</a></li>
                                <li>Additional Game Rules</li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <section class="section-report">
            <h3 class="main-report-title">Additional Game Rules</h3>
            <div class="report-container">
                ...
                <div class="report">
                    ...
                    <div class="report-title">
                        @php
                        $fileUrl = explode('/', $additionalGameRule->url)[1];
                        @endphp
            ...
            <div class="pagination">
                {{ $additionalGameRules->links('pagination::bootstrap-4') }}
            </div>
        </section>
        @include('footer')
    </div>
